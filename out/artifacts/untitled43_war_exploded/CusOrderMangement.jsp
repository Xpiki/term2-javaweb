    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <%--返回上一页--%>
                <li class="active"><a href="/IndexServlet?who=cus&username=<%=username%>">首页</a></li>
                <li><a>我的订单</a></li>
                <li><a>资源</a></li>
            ...
            <div class="user" id="logControll" ng-controller="navUserController"
                ...
                <span id="userlongin"><a><%=username%></a>&nbsp;|&nbsp;<a>我的信息</a></span>
            </div>
        </div>
    </div>
</div>
        ...
        <table class="orderTable" style="width: 100%;border-collapse:collapse; border-spacing:0px 15px">
            ...
            <tr class="othertr" style="background-color: #FFFFFF">
                ...
                <td class="col-2 tdinput">
                    ...
                    <input type="submit" value="提交评价" style="margin-top: 5px"><br>
