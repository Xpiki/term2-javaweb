...
<div class="navbar-fixed-top top" role="navigation" id="menu-nav">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand"><img  style="height: 40px" src="image/icon.png"></a>
        </div>
        <div class="navbar-collapse collapse">
            ...
            <div class="user" id="logControll" ng-controller="navUserController"
                ...
                <span id="userlongin"><a href="Login.jsp?flag=1">登录</a>|<a href="Register.jsp?flag=0">注册</a></span>
            ...
            <div class="scrollspy-nav col-sm-8">
                <div id="shopmenunav">
                    <ul id="nav">
                        ...
                        <li style="border:none;text-align: center "><a href="javascript:goTop();" class="sidetop">Top</a></li>
                    </ul>
                </div>
                <div id="shopmenumain">
                    <%
                    ...
                    <div id="<%=type[i]%>">
                        ...
                        <div class="menufood">
                            <span class="col-1"><img data-action="zoom" class="menufoodimg" src="<%=food.getImage()%>"></span>
                            <div class="col-2">
                                <h3 class="menufoodname"><%=food.getFoodname()%>
                                    <span class="evaluation icon-star">(当前余量:<%=food.getInventory()%>)</span>
                                    <input type="hidden" name="inventory" VALUE="<%=food.getInventory()%>">
                                ...
                                <span>简介:<%=food.getIntroduct()%></span></br>
                                <span class="evaluation icon-star">平均评分:(<%=food.getAvgeva()%>)</span>
                            </div>
...
<script>
    document.getElementById("cusOrder").onclick = function () {
        ...
        %>
            location.href = "OrderMangementServlet?flag=cus&username=<%=username%>";
        <%}%>
    };
